...
from app.agent.travel_system_agents import requirements_agent
...
def requirements_agent_node(state: RequirementsGraphState) -> RequirementsGraphState:
    ...
    #if the requirements are complete, return the requirements
...
graph.add_conditional_edges( "requirements_agent",
